...
**Modargument (tekstnært, ikke etymologisk):** MN 2's egne verber — _uppajjati_ (opstår), _pavaḍḍhati_ (vokser/tiltager), _pahīyati_ (ophæves) — beskriver ikke en retningsbestemt strømning (ind/ud), men et selvstændigt, lukket procesforløb. Bekræftet af faujidoc1 (SC-bruger): MN 2's fokus er netop "the process by which asavas increase or decrease", ikke en flow-arkitektur udefra.
...
2. **Procesfamilien**: Thanissaros ældre "fermentation" (brugt i årevis, bl.a. i "Mind Like Fire Unbound", før han senere skiftede til "effluent" — af grunde, der ikke har kunnet dokumenteres her). Svarer til dansk **"gæring"**, som denne note lander på.
